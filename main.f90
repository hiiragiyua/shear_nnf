program disk3d
  !/********************************************************************/
  !/*    Navier-Stokes incompressible solver                           */
  !/*                                                                  */
  !/*     REFERENCIAS                                                  */
  ...
  !/*                                                                  */
  !/*       - homas J. R. Hughes, Assad A. Oberai, and Luca Mazzei     */
  !/*         (2001) Large eddy simulation of turbulent channel flows  */
  !/*         by the variational multiscale method, Phys. Fluid (13) 6 */
  !/********************************************************************/
  use ctes
  use running
  use bcs
