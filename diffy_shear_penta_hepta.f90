...
subroutine prederiv1
  ...
  allocate ( pr1(-M:M), rh1(-N:N), rh1h(-N:N)  ) !rh1(3),rh1(-3) is 0.d0
...
subroutine prederiv2
  ...
  e2  = dcmplx(0d0,0.d0); f2  = dcmplx(0d0,0.d0); g2  = dcmplx(0d0,0.d0)
  ce2 = dcmplx(0d0,0.d0);cf2 = dcmplx(0d0,0.d0); cg2 = dcmplx(0d0,0.d0)
  ...
  ! B in B*D2 = A*Ru
  pr2(0) = 1.d0
  pr2(1) = 329913.d0/725308.d0; 
  pr2(2) = 18387.d0/362654.d0;
  pr2(3) = 619.d0/725308.d0; 
  pr2(-3) = pr2(3)
  pr2(-2) = pr2(2)
  pr2(-1) = pr2(1)
  
  rh2(0)= -813155.d0/543981.d0; 
  rh2(1)= 263655.d0/725308.d0; 
  rh2(2)= 130977.d0/362654.d0; 
  rh2(3)= 49483.d0/2175924.d0;
  rh2(-3) = rh2(3)
  rh2(-2) = rh2(2)
  rh2(-1) = rh2(1)
  ...
  if (iord.eq.1) then    !!!!!  first derivative
     ...
     if (m.eq.1) then
        ...
        if (ias.eq.1) then
           ...
           call modChol7_addshear(a2,b2,c2,dh,eh,fh,gh,ceh,cfh,cgh,pr2,my,shp)
        end if
...
subroutine update_dy(dy)
  ...
  rh2 = rh2h/h**2
        ...
        write(*,*) 'now hepta-penta is buggy ,,,, update_dy erro'
        stop 
